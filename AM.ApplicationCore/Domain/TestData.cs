...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Flight flight3 = new Flight { FlightDate = new DateTime(2022, 02, 02, 5, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 03, 01, 6, 40, 10), EstimatedDuration = 100, MyPlane = BoingPlane };
